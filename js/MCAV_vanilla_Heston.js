...
var CMC_StdErr, CMC_CompTime, AV_StdErr, AV_CompTime;
...
function CallAV(b, alpha, sigma, s0, K, r, v0, T, rho, n, m){
   ...
   //duration = (clock() - start) / (var) CLOCKS_PER_SEC;
   var end = new Date().getTime();
   AV_StdErr = Math.sqrt(var_payoff /m);
   AV_CompTime = (end - start) /1000.0;
   //cout << alpha <<",  " << rho <<",  " <<  n <<",  " << m <<",  " 
   //cout << call <<",  " << Math.sqrt(var_payoff)<< ",  " <<  Math.sqrt(var_payoff /m) << ",  " << call - 1.96*Math.sqrt(var_payoff /m) << ",  "<< call + 1.96*Math.sqrt(var_payoff /m) << ",  "<< duration << endl;
   return callvalue;
}
...
function Calculate(){
    ...
    document.isForm.c.value = CallAV( b, alpha, sigma, s0, K, r, v0, T, rho, n, m);
    document.isForm.cmc.value = Call( b, alpha, sigma, s0, K, r, v0, T, rho, n, m);
    document.isForm.VarAV.value= AV_StdErr;
    document.isForm.VarCMC.value= CMC_StdErr;
    document.isForm.ComAV.value= AV_CompTime;
...
function Reset(){
    ...
    document.isForm.m.value="5000";
   	document.isForm.c.value ="";  //AV
   	document.isForm.cmc.value ="";  //Crude MC
    document.isForm.VarAV.value ="";  //AV
   	document.isForm.VarCMC.value ="";  //Crude MC
    document.isForm.ComAV.value ="";  //AV
